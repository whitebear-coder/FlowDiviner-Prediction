...
if __name__ == '__main__':
    ...
    # ------------------------模型保存------------------
    run_name = 'GMHCN_train' + '_' + str(g_name) + '_' + str(lr) + '_' + str(epoch) + '_bs' + str(
        batch_size) + '_' + 'lh' + str(look_head) + '_' + 'lb' + str(look_back)
    ...
    # print(y_data_array.shape, y_label_array.shape)
    y_data_array = sl.fit_transform(y_data_array)
    y_data_array = np.log1p(y_data_array)

    y_label_array = ss.fit_transform(y_label_array)
    ...
    features = ss.inverse_transform(features)
    labelss = ss.inverse_transform(labelss)
    ...
    print(features.shape, labelss.shape)
    ...
    data_name = 'GMHCN_test_pred' + '_' + str(g_name) + '_' + str(lr) + '_' + str(epoch) + '_bs' + str(
        batch_size) + '_' + 'lh' + str(look_head) + '_' + 'lb' + str(look_back)
    data = pd.DataFrame(data)
    data.to_csv(os.path.join('/home/hp/LZX/GMHCN/model_total_pred', data_name + '.csv'))

    data = np.concatenate((feature_preds.sum(axis=0).reshape(-1, 1), feature_labels.sum(axis=0).reshape(-1, 1)), axis=0)
    data_name = 'GMHCN_test_pred_total' + '_' + str(g_name) + '_' + str(lr) + '_' + str(epoch) + '_bs' + str(
        batch_size) + '_' + 'lh' + str(look_head) + '_' + 'lb' + str(look_back)
    data = pd.DataFrame(data)
    data.to_csv(os.path.join('/home/hp/LZX/GMHCN/model_pred', data_name + '.csv'))
